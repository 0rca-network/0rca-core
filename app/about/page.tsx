            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  text: "We use Cronos to create a permanent, on-chain record. You prove you own your agent, and you get paid for it.",
                  icon: "⛓️"
                },
                {
          ...
          <div className="container relative z-10 max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-4 gap-8 max-w-6xl mx-auto">
              {[
                ...
                { name: "Jithindranaath [Zephyr]", twitter: "https://x.com/Jithindra57", github: "https://github.com/Jithindranaath", image: jithindranaathImg },
